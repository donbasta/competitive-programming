...
int main() {
  ...
  for(int tc = 1; tc <= T; tc++) {
    ...
    adj1.resize(n + 1); adj2.resize(n + 1); adj.resize(n + 1);
    dep.resize(n + 1); cnt1.resize(n + 1); cnt2.resize(n + 1); cur.resize(n + 1);
    ...
    //clean up
    adj1.clear(); adj2.clear(); adj.clear(); 
    dep.clear(); cnt1.clear(); cnt2.clear(); cur.clear();
  }
  return 0;
}